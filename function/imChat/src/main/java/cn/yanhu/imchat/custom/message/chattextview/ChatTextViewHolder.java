...
public class ChatTextViewHolder extends EaseChatRowViewHolder {

    public ChatTextViewHolder(@NonNull View itemView, MessageListItemClickListener itemClickListener) {
    ...
    public static EaseChatRowViewHolder create(ViewGroup parent,
        ...
        return new ChatTextViewHolder(new ChatTextNew(parent.getContext(), isSender), itemClickListener);
    }

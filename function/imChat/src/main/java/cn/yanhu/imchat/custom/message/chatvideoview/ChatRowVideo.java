...
public class ChatRowVideo extends BaseEaseChatRowFile {
    private static final String TAG = ChatRowVideo.class.getSimpleName();
    ...
    public ChatRowVideo(Context context, boolean isSender) {
        super(context, isSender);
    }

    public ChatRowVideo(Context context, EMMessage message, int position, Object adapter) {
        super(context, message, position, adapter);
    }
	@Override
	protected void onInflateView() {
        inflate = inflater.inflate(!showSenderType ? R.layout.ease_row_received_video

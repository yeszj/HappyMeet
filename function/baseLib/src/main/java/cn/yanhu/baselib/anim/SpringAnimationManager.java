...
public class SpringAnimationManager {
    ...
    public static Animation getAnimation(float tox,float toY,float factor) {
        // 创建缩放的动画对象
        ScaleAnimation sa = new ScaleAnimation(1.0f, tox, 1.0f, toY, ScaleAnimation.RELATIVE_TO_SELF, 0.5f, ScaleAnimation.RELATIVE_TO_SELF, 0.5f);
        // 设置动画播放的时间
        sa.setDuration(1000);

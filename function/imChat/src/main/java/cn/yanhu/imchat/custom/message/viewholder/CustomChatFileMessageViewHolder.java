...
public class CustomChatFileMessageViewHolder extends CustomNormalChatBaseMessageViewHolder {

  private static final String TAG = "ChatFileViewHolder";
  private NormalChatMessageFileViewHolderBinding binding;
  private static final int PROGRESS_MAX = 100;

  public CustomChatFileMessageViewHolder(@NonNull ChatBaseMessageViewHolderBinding parent, int viewType) {

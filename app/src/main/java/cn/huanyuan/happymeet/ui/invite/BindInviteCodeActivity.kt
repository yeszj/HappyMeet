...
import cn.huanyuan.happymeet.databinding.ActivityBindInviteCodeBinding
import cn.huanyuan.happymeet.ui.login.LoginViewModel
import cn.huanyuan.happymeet.ui.login.profile.CompleteProfileActivity
...
class BindInviteCodeActivity : BaseActivity<ActivityBindInviteCodeBinding, LoginViewModel>(
    ...
    private fun toCompleteInfoPage() {
        CompleteProfileActivity.lunch(mContext, loginSuccessInfo!!)
    }

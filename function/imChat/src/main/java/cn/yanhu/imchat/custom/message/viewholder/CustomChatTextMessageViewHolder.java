...
public class CustomChatTextMessageViewHolder extends CustomNormalChatBaseMessageViewHolder {

  NormalChatMessageTextViewHolderBinding textBinding;

  public CustomChatTextMessageViewHolder(@NonNull ChatBaseMessageViewHolderBinding parent, int viewType) {

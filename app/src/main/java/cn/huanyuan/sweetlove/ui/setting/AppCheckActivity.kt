...
import cn.huanyuan.sweetlove.databinding.ActivityAppCheckBinding
import cn.huanyuan.sweetlove.ui.setting.adapter.AppCheckAdapter
import cn.huanyuan.sweetlove.ui.setting.adapter.AppCheckHeadAdapter
import cn.huanyuan.sweetlove.ui.system.ErrorLogPostActivity
                    ...
                    if (!item.hasCheck) {
                        when (item.id) {
                            ...
                            AppCheckItemInfo.TYPE_REAL_NAME -> {
                                RealNameActivity.lunch(mContext,null)
                            }

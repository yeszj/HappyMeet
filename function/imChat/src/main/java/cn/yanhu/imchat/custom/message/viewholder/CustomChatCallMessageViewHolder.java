...
public class CustomChatCallMessageViewHolder extends CustomNormalChatBaseMessageViewHolder {
  ...
  public CustomChatCallMessageViewHolder(@NonNull ChatBaseMessageViewHolderBinding parent, int viewType) {

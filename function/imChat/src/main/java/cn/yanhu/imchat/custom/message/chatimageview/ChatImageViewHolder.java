...
public class ChatImageViewHolder extends EaseChatRowViewHolder {

    public ChatImageViewHolder(@NonNull View itemView, MessageListItemClickListener itemClickListener) {
    ...
    public static EaseChatRowViewHolder create(ViewGroup parent,
        ...
        return new ChatImageViewHolder(new ChatRowImage(parent.getContext(), isSender), itemClickListener);
    }

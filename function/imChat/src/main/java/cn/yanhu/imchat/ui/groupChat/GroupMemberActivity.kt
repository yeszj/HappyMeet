...
class GroupMemberActivity : BaseActivity<ActivityGroupMemberBinding, ImChatViewModel>(
    ...
    override fun initLoadService() {
        val loadSir = initCustomLoadingLoad(CommonLoadingCallBack(cn.yanhu.commonres.R.layout.adapter_loading_user_item))
    ...
    override fun initListener() {
        groupMemberAdapter.setOnItemClickListener { _, _, position ->

...
import cn.huanyuan.sweetlove.databinding.AdapterFriendRequestItemBinding
 ...
 * desc:
 */
class FriendsRequestAdapter: BaseQuickAdapter<SameCityUserInfo, FriendsRequestAdapter.VH>() {
    class VH(
        parent: ViewGroup,
        val binding: AdapterFriendRequestItemBinding = AdapterFriendRequestItemBinding.inflate(

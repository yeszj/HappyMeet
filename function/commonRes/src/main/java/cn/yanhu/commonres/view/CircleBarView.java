...
public class CircleBarView extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        TypedArray typedArray = context.obtainStyledAttributes(attrs, cn.yanhu.commonres.R.styleable.CircleBarView);

        progressColor = typedArray.getColor(cn.yanhu.commonres.R.styleable.CircleBarView_progress_color, Color.GREEN);
        bgColor = typedArray.getColor(cn.yanhu.commonres.R.styleable.CircleBarView_bg_color,Color.GRAY);
        startAngle = typedArray.getFloat(cn.yanhu.commonres.R.styleable.CircleBarView_start_angle,0);
        sweepAngle = typedArray.getFloat(cn.yanhu.commonres.R.styleable.CircleBarView_sweep_angle,360);
        barWidth = typedArray.getDimension(cn.yanhu.commonres.R.styleable.CircleBarView_bar_width, DisplayUtils.dp2px(context,10));
        typedArray.recycle();

        progressNum = 0;
        maxNum = 100;
        defaultSize =  DisplayUtils.dp2px(context,100);
        mRectF = new RectF();

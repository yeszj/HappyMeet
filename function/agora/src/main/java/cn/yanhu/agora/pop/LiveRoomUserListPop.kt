...
class LiveRoomUserListPop(context: Context, private val userList:MutableList<UserDetailInfo>,val ownerInfo:UserDetailInfo) : BottomPopupView(context) {
    ...
    override fun onCreate() {
        ...
        userAdapter.addOnItemChildClickListener(R.id.tv_invite,object : BaseQuickAdapter.OnItemChildClickListener<UserDetailInfo>{
            override fun onItemClick(
                ...
                EmMsgManager.sendCmdMessagePeople(item.userId,ChatConstant.ACTION_MSG_SET_UP,map)
                showToast("上麦邀请已发送")
            }
    ...
    companion object {
        @JvmStatic
        fun showDialog(
            mContext: Context, userList:MutableList<UserDetailInfo>,ownerInfo: UserDetailInfo
        ): LiveRoomUserListPop {

...
public class CustomChatTipsMessageViewHolder extends CustomNormalChatBaseMessageViewHolder {

  private static final String TAG = "ChatTipsMessageViewHolder";

  NormalChatMessageTipViewHolderBinding textBinding;

  public CustomChatTipsMessageViewHolder(@NonNull ChatBaseMessageViewHolderBinding parent, int viewType) {

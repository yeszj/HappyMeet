...
import cn.yanhu.imchat.databinding.AdapterVisitorRuleItemBinding
 ...
 * desc:
 */
class VisitorRuleAdapter:BaseQuickAdapter<String,VisitorRuleAdapter.VH>() {
    class VH(
        parent: ViewGroup,
        val binding: AdapterVisitorRuleItemBinding = AdapterVisitorRuleItemBinding.inflate(
    ...
    private fun AdapterVisitorRuleItemBinding.changeSelect(position: Int) {
        if (position == selectPosition) {
            tvType.backgroundTintList =
                ColorStateList.valueOf(CommonUtils.getColor(R.color.fontGreenColor))

...
object ChatUiConfig {
    fun initConfig(){
        ...
        val instance = ChatViewHolderFactory.getInstance()
        chatUIConfig.chatFactory = instance
        val messageProperties = MessageProperties()
        messageProperties.selfMessageRes =  com.netease.yunxin.kit.chatkit.ui.R.drawable.chat_message_self_bg
        messageProperties.receiveMessageRes = com.netease.yunxin.kit.chatkit.ui.R.drawable.chat_message_other_bg
        messageProperties.showTitleBar = false
        messageProperties.chatViewBackground =
            ColorDrawable(Color.parseColor("#ffffff"))
        messageProperties.avatarCornerRadius = CommonUtils.getDimension(com.zj.dimens.R.dimen.dp_30).toFloat()

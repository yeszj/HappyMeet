...
public class CustomEaseHandleMessagePresenterImpl extends EaseHandleMessagePresenter {
     ...
     * @return
     */
    public String getThumbPath(Uri videoUri) {
     ...
     * @return Uri
     */
    public Uri handleImageHeifToJpeg(Uri imageUri) {
        try {

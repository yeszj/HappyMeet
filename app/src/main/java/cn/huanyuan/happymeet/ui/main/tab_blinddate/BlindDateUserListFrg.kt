...
import cn.huanyuan.happymeet.databinding.FrgBlindDateUserListBinding
 ...
 * desc:
 */
class BlindDateUserListFrg : BaseFragment<FrgBlindDateUserListBinding, MainViewModel>(
    ...
    private fun initVpData() {
        ...
        titles.add("推荐")
        titles.add("专属")
        frgList.add(BlindUserListItemFrg.newsInstance(BlindUserListItemFrg.TYPE_RECOMMEND))
        frgList.add(BlindUserListItemFrg.newsInstance(BlindUserListItemFrg.TYPE_EXCLUSIVE))
        mBinding.apply {

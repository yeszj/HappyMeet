package cn.yanhu.baselib.crash;
...
import cn.yanhu.baselib.crash.compat.ActivityKillerV24_V25;
import cn.yanhu.baselib.crash.compat.ActivityKillerV26;
import cn.yanhu.baselib.crash.compat.ActivityKillerV28;
import cn.yanhu.baselib.crash.compat.IActivityKiller;
...
public final class CrashUtils {
    ...
    private static IActivityKiller sActivityKiller = new ActivityKillerV15_V20();
    ...
    private static void hookmH() throws Exception {
        ...
        @SuppressLint("DiscouragedPrivateApi") Field mhField = activityThreadClass.getDeclaredField("mH");
        mhField.setAccessible(true);
        final Handler mhHandler = (Handler) mhField.get(activityThread);
        @SuppressLint("DiscouragedPrivateApi") Field callbackField = Handler.class.getDeclaredField("mCallback");

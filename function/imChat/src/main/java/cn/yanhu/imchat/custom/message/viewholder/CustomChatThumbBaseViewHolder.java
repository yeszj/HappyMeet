...
public abstract class CustomChatThumbBaseViewHolder extends CustomNormalChatBaseMessageViewHolder {
  private static final String TAG = "ChatThumbBaseViewHolder";

  NormalChatMessageThumbnailViewHolderBinding binding;

  public CustomChatThumbBaseViewHolder(@NonNull ChatBaseMessageViewHolderBinding parent, int viewType) {

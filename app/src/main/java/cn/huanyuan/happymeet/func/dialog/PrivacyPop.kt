...
import cn.huanyuan.happymeet.databinding.PopPrivacyBinding
    ...
    override fun onCreate() {
        ...
        mBinding?.apply {
            val build = Spans.builder()
                ...
                .text("请您务必谨慎阅读充分理解 《用户服务协议》和《用户隐私政策》的各条款。包括但不限于:1、我们会根据你使用服务的具体功能需要，收集必要的用户信息(包括手机号、设备信息、地理位置等)或取得必要的授权(文件读取权限、文件写入权限等)。2、未经您的同意，我们不会从第三方获取，共享或对外提供您的信息。3、我们会收集您的Mac地址、OAID等设备信息进行SDK的初始化工作，并保障APP正常数据统计和安全风控。您可通过阅读完整版的")
                .text("《用户服务协议》")
